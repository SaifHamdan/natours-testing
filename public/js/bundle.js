...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FpZmhhbWRhbiIsImEiOiJja2lrNWpkeW4wNTZtMzFwOXlzMmRiZ295In0.h_ZjmpClUw4whvm4AqjVqQ';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description)).addTo(map); // Extend map to bound
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/users/".concat(url),
              data: data
            });
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourID) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51HyZyvCTYBtBr8cNRSfaMD9yH1OVhLNUAAjUI8ZudmsxfYNXGeVxuvAWh2fK9gVerTfrO5w5mf4isGLSzc6yTb6g00On2Eg16C');
            _context.prev = 1;
            _context.next = 4;
          ...
          case 9:
            ...
            (0, _alerts.showAlert)(_context.t0);
...
var bookBtn = document.getElementById('booktour');
...
if (loginForm) document.querySelector('.form--login').addEventListener('submit', function (e) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            // to prevent the page form reloading
            e.preventDefault();
            document.querySelector('.btn--save--pasword').textContent = 'updating...'; // VALUES
