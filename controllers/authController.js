...
const createSendToken = (user, statusCode, res) => {
  ...
  if (process.env.NODE_ENV === 'production') cookieOptions.ecure = true;
...
exports.login = catchAsync(async (req, res, next) => {
  // we did this that way using destrcutering so each variable sotred in diff location
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  // GRANT ACCESS TO PROCECTED ROUTE
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  // "validateBeforeSave:false" to ignore all the vaildations we specify in model
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // we did this step in middleware
